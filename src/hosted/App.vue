  ...
  <section>
    <div class="container h-100">
      <div class="row h-100 justify-content-center align-items-center">
        <div class="row">
          <div class="col mt-5">
            <h1>A fully working, most feature-rich Vue.js terminal emulator</h1>
            <p class="lead mb-5">
              vue-command offers a simple, yet extensible API, asynchronous commands, fullscreen mode, browsing in
              history, slots and much more.
            </p>
          </div>
        </div>
...
/*Gradients*/
.bg-gradient {
  background: linear-gradient(#333332, #000000);
}
